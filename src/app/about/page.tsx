...
export default function About() {
  return (
    <div className="max-w-6xl mx-auto p-3 space-y-4">
      <h1 className="text-2xl font-medium text-green-500">About</h1>
      <p className="my-4">
        Greetings from MoviBuzz, your one-stop shop for everything movie related! With a vast database of films from many genres, eras, and 
        locations, our website is made to satisfy the interests of movie buffs of all stripes. 
